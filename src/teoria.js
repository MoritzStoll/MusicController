  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      2: [
          ...
          Chord.prototype = {
            ...
            chordType: function() {
              ...
              if (length === 2) {
                ...
                name =
                  has.unison && has.third && has.fifth ? 'triad' : 'trichord';
              } else if (length === 4) {
                has = {
                  unison: false,
                  third: false,
        ...
        { './interval': 3, './knowledge': 4, './note': 5, daccord: 10 }
      ],
      3: [
        function(require, module, exports) {
          var knowledge = require('./knowledge');
          ...
          Interval.invert = function(sInterval) {
            return Interval.toCoord(sInterval)
              .invert()
              .toString();
          };
        ...
        { './knowledge': 4, './vector': 8, 'interval-coords': 12 }
      ],
      4: [
        function(require, module, exports) {
      ...
      5: [
        function(require, module, exports) {
          ...
          Note.prototype = {
            ...
            interval: function(interval) {
              ...
              if (interval instanceof Interval)
                return new Note(
                  vector.add(this.coord, interval.coord),
                  this.duration
                );
          ...
          Note.fromKey = function(key) {
            ...
            var arg = diff
              ? vector.add(note, vector.mul(knowledge.sharp, diff))
              : note;
            return new Note(arg);
          };
        ...
        function(require, module, exports) {
          ...
          Scale.prototype = {
            ...
            get: function(i) {
              ...
              return this.tonic
                .interval(interval)
                .interval(new Interval([octaves, 0]));
            },
      ...
      11: [
        ...
        { 'accidental-value': 9, notecoord: 13 }
      ],
      12: [
        function(require, module, exports) {
